...
<body>
    <div class="form">
        <div class="title">Edita Una pelicula</div>
        <div class="subtitle">la informacion que ingreses será la actualizada</div>
        <div class="input-container ic1">
          <input id="nombreserie" class="input" type="text" placeholder=" " />
          <div class="cut"></div>
          <label for="nombreserie" class="placeholder">Nombre de la serie</label>
        </div>
        <div class="input-container ic1">
